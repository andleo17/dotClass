...
<div class="container my-4">
    <div class="row m-3">
        <div class="col">
            <a type="button" class="btn btn-success" href="<?= SERVER_URL ?>agregar-curso/">Agregar</a>
        </div>
    </div>
    <table class="table">
        ...
        <?php if ($curso != []) { ?>                                
            ...
            <tr class="d-flex">                                                                                 
                ...
                <td class="col-2">
                    <a type='button' class='btn btn-success' href="<?= SERVER_URL ?>administrar-curso/">Ver</a>
