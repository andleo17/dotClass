...
<body>
    ...
    <div class="container">
        <h1>Realiza un aporte</h1>
        <div class="pregunta-curso">
            <img src="https://static.platzi.com/media/learningpath/badges/Badge-desarrollo-java.png" alt="logo">
            <h1>Java avanzado</h1>
        </div>
        <div class="formulario">
            ...
            <textarea name="txtContenido" id="txtContenido" cols="30" rows="10"></textarea>
            <input type="submit" value="Guardar y publicar" id="btnGuardar">
        </div>
    </div>
    <footer>
        <a href="index.php" class="logo">
