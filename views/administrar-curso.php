        ...
        <div class="informacion-curso">
            <div class="icono-curso">
                <img src="https://static.platzi.com/media/learningpath/badges/Badge-desarrollo-java.png"
                    alt="icono-curso">
                <label for="cargar-foto">Modificar ícono</label>
            ...
            <div class="curso-titulo">
                <input type="text" name="txtTituloCurso" id="txtTituloCurso" placeholder="Título del curso"
                    value="Java avanzado">
                <textarea name="txtDescripcionCurso" id="txtDescripcionCurso" placeholder="Descripción del curso">En este curso aprenderás el lenguaje de programación más demandado por el sector empresarial y el mejor remunerado en la actualidad.
Aprenderemos todos juntos acerca de clases anidadas, clases abstractas, lambdas, JDBC y mucho más.</textarea>
            </div>
        </div>
        <div class="precursos">
            <span>Plan de estudios:</span>
            <div class="card-list pre-requisitos">
                <div class="mini-card">
